...
<div class="row actualite">
    <form id="enregistrer-offre" action="categories-menu/<?=$action?>" method="post" class="col-xs-12" enctype="multipart/form-data">
        ...
        <div class="row">
                ...
                <div class="x_panel row">
                    <div class="col-xs-12 col-sm-6 col-lg-5">
                        ...
                        <div class="form-group form-checker">
                            ...
                            <input class="form-control" placeholder="Entrez le nom de la catégorie :" type="text" value="<?=$categorie_menu->name()?>" name="required[alphanum][name]" data-required="Vous devez entrez un nom" required>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-3 col-lg-3 col-lg-offset-1 form-checker">
                        ...
                        <strong>Non</strong>&nbsp;&nbsp;
                        <label class="switch">
                            <input id="js-sous-categorie-checkbox" type="checkbox" name="is_sous_categorie" value="1" <?=($categorie_menu->is_sous_categorie()) ? "checked" : ""?>/>
            ...
            <div class="col-xs-12">
                <div class="x_panel row"> 
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12 col-sm-8">
                                    <div class="form-group form-checker">
                                        ...
                                        <input type="text" name="plats[<?=$key?>]" class="content hidden" value="<?=$value;?>">
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12 col-sm-8">
                                    <div class="form-group form-checker">
                                        ...
                                        <input type="text" name="sous_categories[<?=$key?>]" class="content hidden" value="<?=$value;?>">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-3 col-sm-offset-1 item-edition">
                                    <span class="bouton delete"><span class="fa fa-trash"></span></span>
                    ...
                    <div id="js-ajout-plat" class="col-xs-12 buttons-edition-article">
                        ...
                        <?php 
                            if(!empty($list_plats)) 
                            {
                                ...
                                {
                        ?>
                            <button type="button" class="btn btn-success articleAddItem" data-target="modele_<?=$plat->id_plat();?>" data-type="text">
                                <b><?=$plat->title();?></b>
                            </button>&nbsp;&nbsp; <br>
                        <?php  
                                }
                    ...
                    <div id="js-ajout-sous-categorie" class="col-xs-12 buttons-edition-article">
                        ...
                        <?php 
                            if(!empty($list_sous_categories)) 
                            {
                                ...
                                {
                        ?>
                            <button type="button" class="btn btn-success articleAddItem" data-target="modele_sous_categorie_<?=$sous_categorie->id_categorie_menu();?>" data-type="text">
...
<?php 
    if(!empty($list_sous_categories)) 
    {
        ...
        {
    ?>
<div id="modele_sous_categorie_<?=$sous_categorie->id_categorie_menu();?>" class="article-item ui-state-default form-group hidden">
    <div class="form-group row">
        <div class="col-xs-12 col-sm-8">
            <div class="form-group form-checker">
                <label><?=$sous_categorie->name();?></label>
                <input type="text" name="sous_categories[]" class="content hidden" value="<?=$sous_categorie->id_categorie_menu();?>">
            </div>
        </div>
        <div class="col-xs-12 col-sm-3 col-sm-offset-1 item-edition">
            <span class="bouton delete"><span class="fa fa-trash"></span></span>
