        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="col-md-8 col-sm-8 col-xs-12 form-group pull-right text-right"> 
                    <a href="categories/new/" class="btn btn-success">Ajouter une catégorie</a>
                </div>
            </div>
        </div>
        <!-- end header -->
                        ...
                        <tr>
                          ...
                          <td style="text-align:right">
                           <form method="post" class="edition">
                                <a href="categories/edit/<?=$categorie->id_categorie()?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Modifier</a>
                                <button id="<?=$categorie->id_categorie()?>" class="btn btn-danger btn-xs delete-post" type="button" data-toggle="modal" data-target=".modal-delete"><i class="fa fa-trash-o"></i> Supprimer</button>
                            </form>
                          </td>
                        </tr>
