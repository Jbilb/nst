...
class FormTools
{
        ...
        else
        {
            if(!empty($data))
            {
                switch($key)
                {
                    ...
                    // Type de données attendues : caractères alphabétiques et numériques
                    case 'num':
                        if(!preg_match($PATTERN_num,$data))
                        {
                            $return = false;
                        }
                    break;
    ...
    public function checkFileFormat($key,$data)
    {
        ...
        if(isset($data['name']) && !empty($data['name']))
        {
            ...
            switch($key)
            {
                // Type de données attendues : fichier pdf
                case 'pdf':
                    $ext_allow = array("pdf"); 
                break;
        ...
        switch($format)
        {
            ...
            case 'image_galerie':
                ...
                if (in_array($fileExtension, $validExtensions)) 
                {
                    ...
                    $upload_folder = realpath(__DIR__ . '/../..') .'/uploads/photos/'.$folder; 
                    ...
                    $image_url = 'uploads/photos/'.$folder.'/'. $final_name;
                } 
                else 
                {
                    $image_url = false;
            ...
            case 'pdf':
                ...
                if (in_array($fileExtension, $validExtensions)) 
                {
                    ...
                    move_uploaded_file($data['tmp_name'], $upload_folder.$final_name);

                    $file_url = 'uploads/'.$folder.'/'.$final_name;
                } 
                else 
                {
                    $file_url = false;
