...
$PAGE_name = 'accueil';
$HEADER_title = 'trattoria familiale';
$HEADER_subtitle = 'Le frais, le fin, l’italien';
...
<section id="section-top">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 col-md-offset-3 col-xl-4 col-xl-offset-4">
                            <p class="center vert anim-opacity woow" data-woow-toggle="true" data-woow-offset="70">
                                ...
                                franco-italiens :
                                pizzas, pâtes ou encore gnocchi, sur place ou à emporter, chez Don Camillo, il en faut
                                peu pour
                                être heureux !
                            </p>
                        </div>
    ...
    <section class="index-doubleImg vert-bg" id="index2">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    <div class="img img1 anim-img-parallax" id="img1">
                        <img class="parallax speedImg" data-anchor="#img1" data-css="transform"
                            data-start="translateY(-5%)" data-end="translateY(0%)" width="261" height="388"
                            src="img/content/index/pizzas-italiennes-don-camillo.jpg"
                ...
                <div class="col-xs-12 col-md-5">
                    <span class="s-pastille anim-pastille woow" data-woow-offset="80">
                        <span class="cercle">
                            <img src="img/svg/pastille-olives-texte.svg" alt="pastille-olives-texte">
                        </span>
                        <span class="icons">
    ...
    <article class="c-blocText vert-bg" id="nostraFamiglia">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h2 class="h160 rose anim-bigTitle woow" data-woow-toggle="true" data-woow-offset="80">
                        <div><span>NOSTRA</span></div>
                        <div><span>FAMIGLIA</span></di>
                    </h2>
                </div>
            </div>
        </div>
    ...
    <article class="c-blocText rose-bg" id="pastaPizza">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h2 class="h160 vert right anim-bigTitle woow" data-woow-toggle="true" data-woow-offset="80">
                        <div><span>PASTA &</span></div>
                        <div><span>PIZZA</span></di>
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-3 col-md-offset-9">
                        <h3 class="h3 beige right anim-title woow" data-woow-toggle="true" data-woow-offset="80">
                        ...
                        <p class="beige right v-maxWidth anim-opacity woow" data-woow-toggle="true"
                            ...
                            délicatesse et la
                            générosité de la cuisine franco-italienne.</p>
                    </div>
                </div>
            </div>
            <div class="img posi-left anim-img-parallax" id="img4">
                <img class="parallax speedImg" data-css="transform" data-start="translateY(-5%)"
                    data-end="translateY(0%)" data-anchor="#img4" width="340" height="580"
                    src="img/content/index/pasta-pizza.jpg" alt="Pizzas, pâtes Don Camillo">
            </div>
        </div>
    </article>
    <article class="c-blocText beige-bg" id="fattoInCase">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h2 class="h160 rose anim-bigTitle woow" data-woow-toggle="true" data-woow-offset="80">
                        <div><span>FATTO</span></div>
                        <div><span>IN CASA</span></di>
                    </h2>
                </div>
            </div>
        </div>
        <div class="content-bot">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-3">
                        <h3 class="h3 vert3 anim-title woow" data-woow-toggle="true" data-woow-offset="80"><span>De la
            ...
            <div class="img posi-right anim-img-parallax" id="img5">
                <img class="parallax speedImg" data-css="transform" data-start="translateY(-5%)"
                    data-end="translateY(0%)" data-anchor="#img5" width="340" height="580"
                    src="img/content/index/fatto-in-casa.jpg" alt="Pizzas, pâtes ou encore burger">
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-4 col-md-offset-1">
                    ...
                    <p class="blanc anim-opacity woow" data-woow-toggle="true" data-woow-offset="70">Soucieux de
                        ...
                        dans notre distributeur.<br class="keep"><br class="keep">

                        • Envie de déguster immédiatement votre pizza ? <br class="keep">
                        En seulement 3 minutes, c’est possible ! <br class="keep"><br class="keep">

                        • Envie de la savourer à la maison ? Récupérez votre pizza en 30 secondes et terminez sa cuisson
                        au four.
                    </p>
                </div>
                <div class="col-xs-12 col-md-5 col-md-offset-1">
                    <figure class="img anim-img-parallax" id="imgDistributeur">
                        <img width="375" height="385" class="parallax speedImg" data-css="transform"
                            ...
                            src="img/content/index/distributeur-pizzas.jpg" alt="distributeur de pizzas Don Camillo">
                    </figure>
                </div>
            </div>
        </div>
    ...
    <?php include 'includes/index-magazine.php'; ?>
</section>
