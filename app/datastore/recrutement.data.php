...
return $recrutement = (object) array(
    "chef_de_rang" => (object) array(
        ...
        "list"     => 
            (object) array(
                "01"      => "Accueil et conseil client",
                "02"     => "Prise de commande",
                "03"     => "Suivi de rang de 50 couverts",
                "04"     => "Application des normes d’hygiène",
            ),
    ),
    ...
    "grilladin" => (object) array(
        ...
        "list"     => 
            (object) array(
                "01"      => "Réalisation de la cuisson des viandes et poissons",
                "02"     => "Réalisation des sauces",
                "03"     => "Application des normes d’hygiène et<br> respect de la chaîne du chaud",
            ),
    ),
    "patissier" => (object) array(
        ...
        "list"     => 
            (object) array(
                "01"      => "Préparation et dressage des desserts",
                "02"     => "Approvisionnement et stockage",
                "03"     => "Application des normes d’hygiène",
            ),
    ),
    "barman" => (object) array(
        ...
        "list"     => 
            (object) array(
                "01"      => "Gestion du bar",
                "02"     => "Préparation des boissons alcoolisées et soft",
                "03"     => "Application des normes d’hygiène",
            ),
    ),
    "cuisinier" => (object) array(
        ...
        "list"     => 
            (object) array(
                "01"      => "Préparation et dressage des plats",
                "02"     => "Cuisson des pâtes, gnocchis et raviolis",
                "03"     => "Réalisation des sauces",
                "04"     => "Approvisionnement et stockage",
                "05"     => "Application des normes d’hygiène",
            ),
    ),
    "plongeur" => (object) array(
        ...
        "list"     => 
            (object) array(
                "01"      => "Nettoyage des assiettes, des couverts et des verres",
                "02"     => "Rangement des couverts, assiettes et ustensiles",
                "03"     => "Application des normes d’hygiène",
            ),
    ),
);
