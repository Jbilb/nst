...
$LEGALS_client_name = "Joel PALMERIO et Lorenzo PALMERIO";
$LEGALS_client_role = "gérants";
$LEGALS_client_statut = "SARL";
$LEGALS_client_capital = "7 622,45 €";
$LEGALS_client_nom_dirigeant = "Joel PALMERIO et Lorenzo PALMERIO";
$LEGALS_client_rcs = "RCS de PAMIERS";
$LEGALS_client_siren = "397 720 830";
$LEGALS_client_siegesocial = "DON CAMILLO, AV DE LA BOURIETTE 09100 PAMIERS";
$LEGALS_client_mail  = "direction- pamiers@doncamillo-restaurants.fr";
$LEGALS_client_tel  = "09 74 19 08 09";
    ...
    <div class="container beige-bg">
        <div class="row">
            <div class="col-xs-12 col-sm-10 col-sm-offset-1 i-legals_texte">
                <h1 class="h2 vert legals_titre">Mentions Légales</h1>
                <p>
                    ...
                    à consulter le site : <a href="https://www.cnil.fr/">https://www.cnil.fr/</a>
                    <br /><br />
                    ...
                    <br /><br />
                    <?php echo $LEGALS_client_societe; ?> <?php echo $LEGALS_client_statut; ?>, au capital de
                    <?php echo $LEGALS_client_capital; ?>, dont le siège social est situé:
                    <?php echo $LEGALS_client_siegesocial; ?> <br>
                    représentée par <?php echo $LEGALS_client_nom_dirigeant; ?>, en leurs qualitées de
                    ...
                    adresse mail : <a
                        href="mailto:<?php echo $LEGALS_client_mail; ?>"><?php echo $LEGALS_client_mail; ?></a>,
                ...
                <p>
                    ...
                    <br /><br />
                    Le matériel de connexion au site que vous utilisez est sous votre entière responsabilité. Vous devez
                ...
                <p>
                    ...
                    strictement interdite, sauf autorisation préalable et écrite de l'éditeur.
                    <br /><br />
                    ...
                    charge de l'éditeur.
                    <br /><br />
                    Toute information accessible via un lien vers d'autres sites n'est pas publié par l'éditeur.
                    L'éditeur ne dispose d'aucun droit sur le contenu présent dans ledit lien.
                </p>
                <p>
                    <strong id="protection-donnees" class="legals_subtitle">Article 7 - Collecte et protection des
                        données</strong>
                ...
                <p>
                    <strong class="legals_subtitle">Article 8 - Droit d’accès, de rectification et de déréférencement de
                        vos données</strong>
                    ...
                    <br /><br />
                    Vous pouvez exercer ce droit en nous contactant, par email, à l’adresse : <a
                        href="mailto:<?php echo $LEGALS_client_mail; ?>"><?php echo $LEGALS_client_mail; ?></a>
                    <br /><br />
                    ...
                    sujet, vous pouvez consulter le site Internet de la CNIL : <a href="https://www.cnil.fr/"
                        target="_blank">https://www.cnil.fr/</a>.
                    <br /><br />
                ...
                <p>
                    ...
                    conditions, nous pouvons également conserver certaines de vos informations si nécessaire, même si
                    nous n'en n'avons plus besoin pour vous fournir des services.
                </p>
                <p>
                ...
                <p>
                    ...
                    constituer une atteinte à la vie privée ou à la réputation des personnes. L'éditeur décline toute
                ...
                <p>
                    ...
                    type de navigateur, nous vous invitons à consulter le lien suivant : <a
                        href="https://www.cnil.fr/fr/cookies-les-outils-pour-les-maitriser">https://www.cnil.fr/fr/cookies-les-amis-pour-les-maitriser</a>.
                </p>
                <p>
